...
phenames <- c("Glo1 expression", "Cyp4f16 expression")

load(file.path(PATH_TO_DATA, "DO378_islet_ENSMUSG00000048440.RData"))
load(file.path(PATH_TO_DATA, "DO378_islet_ENSMUSG00000024026.RData"))
...
X1 <- pp5[ , , index] #index is from command line args
...
fn <- paste0("2017-10-25_boot2_", proc_num, "_", paste(phenames, collapse = "_"), ".txt")
write.table(lrt, fn)
q("no")
