...
fn <- paste0("2017-10-30_Ysim_", trait_file_num, ".txt")
...
(unlist(read.csv(file.path(PATH_TO_SIM_DATA, "pleio_peak_indices.csv"))) -> pleio_peak_indices)
...
fn <- paste0("2017-10-30_", proc_num, "_", paste(phenames, collapse = "_"), ".txt")
write.table(lrt, fn)
q("no")
